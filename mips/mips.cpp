...
void* mips::dispatch() {
  ...
  if( ac_pc - 0x80000000 >= DM.get_size()){
...
void mips::behavior() {
  ...
  void* vet[] = {&&I_Init, &&I_lb, &&I_lbu, &&I_lh, &&I_lhu, 
              ...
              &&I_sys_call, &&I_eret, &&I_deret, &&I_sync, &&I_teq, 
              &&I_ll, &&I_sc, &&I_movz, &&I_movn, &&I_mul, 
              &&I_clz, &&I_seb, &&I_seh, &&I_ext, &&I_rotr, 
              &&I_rotrv, &&I_absd, &&I_abss, &&I_addd, &&I_adds, 
              &&I_ceqd, &&I_ceqs, &&I_coled, &&I_coles, &&I_coltd, 
              &&I_colts, &&I_cueqd, &&I_cueqs, &&I_culed, &&I_cules, 
              &&I_cultd, &&I_cults, &&I_cund, &&I_cuns, &&I_cvtsd, 
              &&I_cvtds, &&I_cvtdw, &&I_cvtsw, &&I_divd, &&I_divs, 
              &&I_mfc1, &&I_movd, &&I_movs, &&I_muld, &&I_muls, 
              &&I_mtc1, &&I_negd, &&I_negs, &&I_subd, &&I_subs, 
              &&I_truncwd, &&I_truncws, &&I_bc1tl, &&I_bc1t, &&I_bc1f, 
              &&I_bc1fl, &&I_sdc1, &&I_ldc1, &&I_swc1, &&I_lwc1, 
              &&I_sqrtd, &&I_sqrts, &&I_movf, &&I_movt, &&I_maddd, 
              &&I_msubd, &&I_movzd, &&I_movnd, &&I_movtd, &&I_movfd, 
              &&I_madds, &&I_msubs, &&I_movns, &&I_movts, &&I_movfs, 
              &&I_movzs, &&I_mfhc1, &&I_mthc1, &&I_ldxc1, &&I_sdxc1, 
              &&I_lwxc1, &&I_swxc1, &&I_mfc0, &&I_mtc0};
